...
class SwarmMetrics:
    ...
    def drone_collisions(self) -> int:
        """Return agents with drone collisions."""
        return sum(
    ...
    def obstacle_collisions(self) -> int:
        """Return agents with obstacle collisions."""
        return sum(
    ...
    def boundary_violations(self) -> int:
        """Return agents with boundary violations."""
        return sum(
    ...
    def visible_obstacles(self) -> int:
        """Return total visible obstacles."""
        return sum(
    ...
    def to_dict(
        ...
        """Return JSON-compatible swarm metrics."""
        payload = {
            "step": int(self.step),
...
class MetricsTracker:
    ...
    def summary_json(self) -> str:
        """Encode overall summary as JSON."""
